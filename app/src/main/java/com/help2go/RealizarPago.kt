...
import com.help2go.R
import com.help2go.viewmodel.RealizarPagoViewModel
import com.help2go.databinding.ActivityRealizarPagoBinding
...
class RealizarPago : AppCompatActivity() {
    ...
    private val model: RealizarPagoViewModel by viewModels()

    private lateinit var layoutBinding: ActivityRealizarPagoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layoutBinding = ActivityRealizarPagoBinding.inflate(layoutInflater)
